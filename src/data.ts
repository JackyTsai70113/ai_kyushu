  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        memo: "採買移到大觀峰之前，避免黑川散策後趕 17:00。草千里下山往阿蘇車站途中約 12:55-13:05 會再經過米塚附近，可看右側草原與火山丘線條。買到需冷藏的牛奶、布丁與水果，放保冷袋或車上陰涼處。高人氣優先點餐指引｜不限飲食：1. 阿蘇赤牛便當，原因是在地代表性高、回別墅可直接吃；2. 阿蘇高菜飯糰，原因是阿蘇名物，適合長輩與小孩；3. ASO MILK 牛奶或布丁，原因是阿蘇乳製品人氣高。無肉塊：高菜飯糰、蔬果、麵包或甜點；熟食高湯可接受肉湯或魚介，便當配菜若有肉塊挑開。",
