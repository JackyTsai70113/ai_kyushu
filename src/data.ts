...
export const ITINERARY_DATA: ItineraryDay[] = [
  {
    ...
    date: "2026/07/04",
    weekday: "六",
    title: "抵達熊本、MERUKORO 買麵包、草千里午餐、砂千里短停、入住 CAN LI ASSO",
    subTitle: "熊本機場下飛機開始，先買 MERUKORO，再到草千里 Green Park 午餐，砂千里短停後回別墅",
    ...
    mainTheme: "熊本機場 ｜ 手作烘焙 ｜ 草千里 Green Park 午餐 ｜ 砂千里之濱 ｜ 包棟自炊",
    note: "住：南阿蘇 CAN LI ASSO。第一天從熊本機場下飛機開始，取車後先到 MERUKORO PAN-KOUBOU 買麵包，再上草千里 Green Park 吃中餐，接砂千里之濱短停，最後高森補給與入住。",
    meals: {
    ...
    rainBackup: "草千里或砂千里若大雨、濃霧或火山管制，午餐仍可在草千里 Green Park / CAFE & SHOP GRASS LAND 室內解決，砂千里直接取消。MERUKORO 只買重點麵包，改以 Frein 超市與南阿蘇迷你超市補給為主，提早回 CAN LI ASSO 休息。",
    ...
    items: [
      ...
      },
      {
        time: "15:45 - 16:15",
        place: "砂千里之濱短停",
        move: "草千里 Green Park 至砂千里之濱約 10 分鐘",
        plan: "砂千里之濱改排第一天。若天候與火山管制允許，短停看黑色火山砂地形、拍照後下山往高森補給。",
        memo: "風大、地面裸露，長輩與小孩以短停為主。若火山口周邊封鎖、濃霧或路況不佳，直接跳過，不影響入住。",
  ...
  },
  {
    ...
    date: "2026/07/05",
    weekday: "日",
    title: "7/5 阿蘇火山口、阿蘇補給、ASO MILK FACTORY、大觀峰",
    subTitle: "第二天阿蘇山上區域只保留阿蘇中岳火山口，午後採買、乳製品甜點、大觀峰與黑川短停",
    hotel: "南阿蘇 CAN LI ASSO 自炊包棟別墅",
    hotelUrl: "https://www.google.com/maps/search/?api=1&query=CAN%20LI%20ASSO%20%E5%8D%97%E9%98%BF%E8%98%87",
    hotelImageUrl: "https://owners-inn.com/wp/wp-content/uploads/2025/08/20250730_106-1-scaled.jpg",
    hotelImageSourceUrl: "https://owners-inn.com/?p=18895",
    hotelImageSourceName: "Owners-Inn 官方住宿頁",
    mainTheme: "阿蘇中岳火山口 ｜ 阿蘇午餐 ｜ 晚餐採買 ｜ ASO MILK FACTORY ｜ 大觀峰",
    note: "住：CAN LI ASSO。砂千里之濱已改到 Day 1，第二天阿蘇山上區域只保留阿蘇中岳火山口；若火山口管制，改阿蘇火山博物館或提早下山吃午餐。",
    meals: {
      breakfast: "於別墅享用：前一日在 MERUKORO、Frein 超市或高森周邊採購的麵包、牛奶、水果與簡單早餐",
      lunch: "ごとう屋阿蘇店或阿蘇車站周邊午餐：火山口後下山用餐，再接阿蘇車站農產品店採買",
    ...
    rainBackup: "阿蘇中岳火山口極易受大雨、濃霧或火山管制影響封鎖。若火山口不開放，改阿蘇火山博物館或直接下山往阿蘇午餐與採買。晚餐採買固定放在大觀峰之前；下午若黑川散策遇雨，改為短停拍照或直接回 CAN LI ASSO。",
    ...
    items: [
      ...
      {
        time: "10:30 - 11:25",
        place: "阿蘇中岳火山口 → ごとう屋阿蘇店",
        move: "自駕約 40-55 分鐘，下山往阿蘇午餐",
        plan: "火山口結束後下山吃午餐，午餐後再接阿蘇車站農產品店採買晚餐。",
        memo: "若火山口管制，這段會提早；可先在阿蘇車站周邊休息或提前用餐。",
        category: "car",
      },
      {
        time: "11:25 - 12:20",
        place: "ごとう屋阿蘇店午餐",
        move: "抵達後用餐",
        plan: "午餐吃阿蘇赤牛，補足上午火山口與山路移動消耗的體力。若現場排隊太長，改阿蘇車站周邊簡餐。",
        memo: "高人氣優先點餐指引｜不限飲食：1. 阿蘇赤牛丼；2. 赤牛燒肉定食；3. 赤牛牛排定食。無肉塊：高菜飯、漬物與白飯組合；味噌湯可接受魚介高湯，套餐肉塊分給同行者。",
        mapUrl: "https://www.google.com/maps/search/?api=1&query=%E3%81%94%E3%81%A8%E3%81%86%E5%B1%8B%20%E9%98%BF%E8%98%87%E5%BA%97",
        category: "food",
      },
      {
        time: "12:35 - 13:05",
        place: "阿蘇車站農產品店（道の駅 阿蘇）採買晚餐",
        move: "ごとう屋至阿蘇車站約 10-15 分鐘",
        plan: "先在阿蘇車站旁農產品店把晚餐主食買齊，再往 ASO MILK FACTORY 與大觀峰。優先買阿蘇高菜飯糰、熟食便當、在地蔬果，回 CAN LI ASSO 直接分食，不再找晚餐餐廳。",
        memo: "採買移到大觀峰之前，避免黑川散策後趕 17:00。買到需冷藏的水果與熟食，放保冷袋或車上陰涼處。高人氣優先點餐指引｜不限飲食：1. 阿蘇赤牛便當，原因是在地代表性高、回別墅可直接吃；2. 阿蘇高菜飯糰，原因是阿蘇名物，適合長輩與小孩；3. ASO MILK 牛奶或布丁可留到下一站 ASO MILK FACTORY 補。無肉塊：高菜飯糰、蔬果、麵包或甜點；熟食高湯可接受肉湯或魚介，便當配菜若有肉塊挑開。",
  ...
  },
  {
    ...
    subTitle: "小火車優先、高千穗峽散步、高森赤牛或南阿蘇蕎麥、白川水源、傍晚進熊本",
    ...
    mainTheme: "高千穗小火車 ｜ 峽谷步道 ｜ 白川水源 ｜ 熊本市區",
    note: "住：REF Kumamoto by VESSEL HOTELS。高千穗小火車優先，峽谷只散步拍照；中午約 12:00 自高千穗啟程，午餐主方案改高森町やま康赤牛丼，清爽備案為久木野庵手工蕎麥麵，餐後接白川水源再進熊本市區。",
    meals: {
      breakfast: "在別墅內享用愜意晨食：簡單烘烤熱吐司、煎雞蛋與香濃咖啡/熱牛奶（準備行李退房）",
      lunch: "主方案：高森町 やま康吃赤牛丼；清爽備案：南阿蘇 久木野庵吃手工蕎麥麵，餐後接白川水源最順",
    ...
    rainBackup: "高千穗小火車若班次客滿，改拍高千穗駅與前往峽谷散步；峽谷遇大雨時不走濕滑步道，縮短拍照後提早往高森午餐。白川水源小雨可短停，若雨勢變大則直接前往 REF。",
    ...
    items: [
      ...
      },
      {
        ...
        move: "高千穗駅至峽谷約 10 分鐘",
        plan: "走峽谷步道，看真名井瀑布、拍照。停留到中午前後，12:00 左右自高千穗啟程往高森午餐。",
      ...
      },
      {
        ...
        place: "高千穗 → 高森町 やま康",
        move: "自駕約 30-40 分鐘",
        plan: "中午 12 點左右自高千穗啟程，順路到高森町やま康吃赤牛丼。這段比繞遠回阿蘇市區更貼近白川水源方向。",
        memo: "若高千穗段延誤或やま康現場排隊太長，改直奔南阿蘇久木野庵吃手工蕎麥麵，一旁接白川水源動線更短。",
        category: "car",
      },
      {
        time: "12:35 - 13:35",
        place: "やま康 赤牛丼午餐（備案：久木野庵手工蕎麥麵）",
        move: "抵達後用餐",
        plan: "肉食與名物體驗走やま康赤牛丼；若想吃清爽在地風味，改久木野庵手工蕎麥麵，利用阿蘇純淨水源做出的料理，餐後接白川水源很順。",
        memo: "高人氣優先點餐指引｜やま康：1. 赤牛丼，原因是高森町代表性的阿蘇赤牛體驗；2. 赤牛定食，原因是份量穩、長輩好分食；3. 小份牛肉料理加白飯，原因是下午還要移動。久木野庵備案：手工蕎麥麵、天婦羅蕎麥或冷蕎麥，清爽不負擔。無肉塊：久木野庵蕎麥麵優先；若在やま康則以白飯、漬物、湯品與可分食配菜處理。",
      ...
      },
      {
        time: "13:35 - 13:50",
        place: "午餐點 → 白川水源",
        move: "やま康約 10-15 分鐘；久木野庵則幾乎就在白川水源旁",
        plan: "飽餐後接白川水源散步。若選久木野庵，餐廳與白川水源距離極近，動線最省力。",
        memo: "這段接白川水源後直接進熊本市區，下午移動壓力較小。",
        category: "car",
      },
      {
        time: "13:50 - 14:40",
