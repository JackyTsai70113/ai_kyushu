...
export const ITINERARY_DATA: ItineraryDay[] = [
  ...
  },
  {
    ...
    hotel: "南阿蘇 CAN LI ASSO 自炊包棟別墅",
    hotelUrl: "https://www.google.com/maps/search/?api=1&query=32.8234378,131.0261628",
    mainTheme: "極地火山 ｜ 外輪山絕景 ｜ 自由彈性北阿蘇",
    note: "住：CAN LI ASSO。住宿改在南阿蘇後，Day 2 以阿蘇山區為核心；北側遠點鍋瀑布或黑川溫泉只作可選段落，若長輩或小孩疲累，可直接回包棟別墅休息享受森林時光。",
    meals: {
      breakfast: "於別墅享用：前一日在 MERUKORO 與道之驛阿蘇採購之美味手作麵包、ASO MILK 牧場鮮奶與新鮮水果",
      lunch: "地圖推薦極味餐廳：あか牛丼専門店 ごとう屋阿蘇店，品嚐香烤頂級阿蘇赤牛丼（Akaushi Dong）",
      dinner: "別墅主廚自炊烹飪派對或回程路上自選精緻日式家常餐（或於黑川溫泉街品嚐地產美食小吃）"
    },
    weatherForecast: "阿蘇火山口與草千里屬中高海拔（標高約 1,140m），7 月山頂氣溫僅約 18°C~23°C，風勢甚猛、常現濃霧。紫外線偏高強，全體請備妥輕巧抗風防寒外套、太陽帽與遮陽傘。",
    rainBackup: "阿蘇火山和中岳火山口極易受大雨或濃霧影響封鎖。若遭遇封鎖：① 棄火山口，改去草千里旁的【阿蘇火山博物館】吹冷氣。② 若下大雨，取消戶外大觀峰，改在「草千里珈琲焙煎所」看雨中大草原。③ 傍晚鍋瀑布與黑川散策若遇雨，果斷取消，提早半天回「CAN LI ASSO」別墅聚會聊天、自炊下麵泡熱茶，最溫馨愜意。",
    ...
    items: [
      ...
      },
      {
        ...
        plan: "吃頂級名產『赤牛丼（Akaushi Dong）』。這家美味赤牛香烤丼飯，飯香肉嫩，家人吃過都特別喜歡。",
        memo: "停車：餐廳自設或周圍合作免費停車位。人多時先抽整理券。",
      ...
      {
        time: "15:00 - 17:30",
        place: "鍋瀑布 / 黑川溫泉散策 (可選行程)",
        move: "大觀峰往返車程較長",
        plan: "此為彈性可選行程。若天氣良好且家人體力充沛，可前往欣賞絕美的簾幕瀑布，或漫步黑川溫泉街吃 Patisserie Roku 的窯烤泡芙；若疲累或下雨，則直接回 CAN LI ASSO 包棟別墅休息。",
        memo: "停車：鍋瀑布大停車場 / 風の舎 (黑川溫泉遊客中心停車)。需要網上預約鍋瀑布門票噢！",
      ...
      },
      {
        ...
        move: "大觀峰回別墅約 45-60 分；黑川回別墅約 70-90 分",
        plan: "回到南阿蘇舒適包棟別墅大客廳，晚餐以別墅自炊、外帶或超商買回美食拼盤，全家圍坐聊天，十分悠閒。",
        memo: "別墅住宿空間大。檢查、整理好明天前往高千穗划船隨身攜帶的水晶小袋與防潑水衣服。",
        mapUrl: "https://www.google.com/maps/search/?api=1&query=32.8234378,131.0261628",
        category: "hotel",
      },
    ],
    ...
    items: [
      {
        ...
        move: "至高千穗約 80-100 分",
        plan: "退房、行李上車，朝高千穗前進，途中僅做公路超商或洗手間短停，保持老小舒適。需提前抵達，絕對不可延誤划船班次報到。",
