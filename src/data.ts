...
export const ITINERARY_DATA: ItineraryDay[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        memo: "停車：MERUKORO 店旁/店前專用停車場。點餐指引｜不限飲食：1. 可頌或奶油丹麥，原因是剛出爐酥皮與奶油香最明顯；2. 鮮乳夾心包，原因是柔軟好分食，長輩小孩接受度高；3. 無花果核桃歐包，原因是耐放，適合帶回別墅當早餐。方便素：原味、果乾、堅果或起司麵包，避開火腿、培根、明太子等鹹餡。",
      ...
      },
      {
        ...
        memo: "停車：住宿停車位，請依訂房指示停放。若改山麓キッチン燒肉外食，點餐指引｜不限飲食：1. 阿蘇赤牛燒肉拼盤，原因是最能吃到在地牛肉香；2. 牛舌，原因是口感脆彈，和赤牛瘦肉互補；3. 牛五花，原因是油脂香明顯，適合多人分食。方便素：白飯、沙拉與烤野菜，醬汁可能含肉或魚介萃取，介意者改鹽或原味。",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        memo: "停車：草千里付費大停車場。點餐指引｜不限飲食：1. 阿蘇赤牛丼，原因是不下山也能吃到阿蘇代表食材；2. 赤牛咖哩，原因是份量穩定、上餐快；3. 阿蘇牛奶霜淇淋，原因是餐後降溫，小孩也好分食。方便素：高菜飯、白飯、沙拉或麵包類，避開火腿、培根品項；咖哩醬可能含肉類高湯。",
      ...
      },
      {
        ...
        memo: "這樣排的好處是上午不用折返、午餐穩定，下午保留彈性。若選黑川溫泉街輕食，點餐指引｜不限飲食：1. 溫泉布丁，原因是份量小、停留短也能吃；2. 泡芙或蛋糕，原因是好外帶，不影響後續移動；3. 咖啡或茶飲，原因是山路前能休息醒腦。方便素：無肉甜點或無酒精飲品，多數甜點含蛋奶，介意吉利丁者現場確認。",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        memo: "若現場排隊太長，改外帶或附近簡餐，不影響 15:30 八千代座。點餐指引｜不限飲食：1. 阿蘇赤牛丼，原因是最直覺吃到赤牛肉香與白飯搭配；2. 赤牛燒肉定食，原因是肉的厚度與口感比丼飯更明顯；3. 赤牛牛排定食，原因是想認真吃阿蘇牛時最有滿足感。方便素：高菜飯、漬物與白飯組合；味噌湯可能有魚介高湯，嚴格素不建議。",
      ...
      },
      {
        ...
        memo: "停車：飯店合作或自設大停車場。若晚餐在熊本新市街美食街自選，點餐指引｜不限飲食：1. 熊本拉麵，原因是黑蒜油豚骨最具代表性且上餐快；2. 壽司或海鮮丼，原因是可依食量自由加減；3. 居酒屋烤飯糰與炸物，原因是多人同行容易分食。方便素：玉子、納豆、黃瓜卷、稻荷壽司、烤飯糰或冷豆腐；醬汁與高湯可能含魚介。",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        memo: "停車：AMU PLAZA 專用超大地下/立體停車場。黑亭點餐指引｜不限飲食：1. 玉子入りラーメン，原因是黑蒜油豚骨加蛋最完整；2. 黑亭拉麵基本款，原因是最能吃出焦蒜油與中粗麵特色；3. 煎餃或炒飯，原因是多人可加點分食，不必每人都吃大碗。方便素：黑亭本身不適合方便素，建議在 AMU PLAZA 改買飯糰、麵包或甜點；若仍同桌，可把叉燒分給其他人。",
      ...
      },
      {
        ...
        memo: "先以 Google Maps 搜尋「天ぷら たかお 熊本」確認當日營業時間與最近分店。點餐指引｜不限飲食：1. たかお天定食，原因是一次吃到招牌綜合天婦羅；2. 蝦天定食，原因是最穩、長輩小孩都容易接受；3. 魚介天婦羅定食，原因是口味比單吃蔬菜更有層次。方便素：野菜天婦羅加白飯；炸油與沾醬可能和海鮮共用，介意者改白飯與漬物。",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        memo: "停車：櫻之馬場 城彩苑 大專用停車場。點餐指引｜不限飲食：1. 海膽可樂餅，原因是外酥內餡香濃，是城彩苑代表小吃；2. 熊本熊大判燒，原因是造型有記憶點，小孩接受度高；3. 阿蘇布丁或牛奶霜淇淋，原因是 7 月中午清涼好分食。方便素：紅豆或卡士達大判燒；多數甜點含蛋奶，不吃蛋奶者改茶飲或水果類商品。",
      ...
      },
      {
        ...
        memo: "建議車子依舊安留 REF 免費停放。SWISS 點餐指引｜不限飲食：1. 鮮奶油草莓蛋糕，原因是經典、長輩小孩都容易接受；2. 季節水果蛋糕，原因是清爽，晚餐後不會太膩；3. 巧克力蛋糕，原因是外帶較耐放、較不怕擠壓。方便素：布丁、泡芙或小份杯裝甜點；多數含蛋奶，若介意吉利丁需現場確認。",
      ...
      },
      {
        ...
        memo: "建議車留飯店，直接步行前往。勝烈亭點餐指引｜不限飲食：1. 鹿兒島六白黑豚里脊豬排定食，原因是肉味濃、脂香明顯；2. 菲力豬排定食，原因是口感較嫩、油脂較低，適合長輩；3. 炸蝦或綜合炸物定食，原因是不想全吃豬排時可換口味。方便素：白飯、高麗菜、漬物與味噌湯；主菜肉類可分給其他人，味噌湯可能含魚介高湯。",
