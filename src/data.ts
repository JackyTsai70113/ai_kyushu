...
export const ITINERARY_DATA: ItineraryDay[] = [
  {
    ...
    subTitle: "先買 MERUKORO PAN-KOUBOU 麵包，再到草千里 Green Park 午餐，高森補給後回別墅",
    ...
    mainTheme: "手作烘焙 ｜ 草千里 Green Park 午餐 ｜ 高森補給 ｜ 包棟自炊",
    note: "住：南阿蘇 CAN LI ASSO。第一天改為取車後先到 MERUKORO PAN-KOUBOU 買麵包，再上草千里 Green Park 吃中餐，最後接高森補給與入住。",
    meals: {
    ...
    rainBackup: "草千里若大雨或濃霧，午餐仍可在草千里 Green Park / CAFE & SHOP GRASS LAND 室內解決。若雨勢變大，MERUKORO 只買重點麵包，改以 Frein 超市與南阿蘇迷你超市補給為主，提早回 CAN LI ASSO 休息。",
