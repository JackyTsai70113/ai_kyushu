  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        memo: "採買移到大觀峰之前，避免黑川散策後趕 17:00。買到需冷藏的牛奶、布丁與水果，放保冷袋或車上陰涼處。高人氣優先點餐指引｜不限飲食：1. 阿蘇赤牛便當，原因是在地代表性高、回別墅可直接吃；2. 阿蘇高菜飯糰，原因是阿蘇名物，適合長輩與小孩；3. ASO MILK 牛奶或布丁，原因是阿蘇乳製品人氣高。無肉塊：高菜飯糰、蔬果、麵包或甜點；熟食高湯可接受肉湯或魚介，便當配菜若有肉塊挑開。",
      ...
      },
      {
        ...
        memo: "16:10 前離開黑川，回別墅時間較穩。高人氣優先點餐指引｜不限飲食：1. 溫泉布丁，原因是溫泉街常見人氣甜點，份量小也好入口；2. 泡芙或蛋糕，原因是甜點店熱門外帶品項，不影響後續移動；3. 咖啡或茶飲，原因是搭配甜點最穩，山路前也能休息醒腦。無肉塊：無肉甜點或無酒精飲品；蛋奶與吉利丁可依個人接受度，重點避開明顯肉塊。",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        memo: "停車：AMU PLAZA 專用超大地下/立體停車場。黑亭高人氣優先點餐指引｜不限飲食：1. 玉子入りラーメン，原因是黑亭代表款方向，黑蒜油豚骨加蛋最完整；2. 黑亭拉麵基本款，原因是最能吃出焦蒜油與中粗麵特色；3. 煎餃或炒飯，原因是拉麵店常見人氣配餐，適合多人分食。無肉塊：可點拉麵把叉燒分給其他人，湯底可接受豚骨；若想更清爽，改在 AMU PLAZA 買飯糰、麵包、甜點或炒飯，肉末挑開即可。",
      ...
      },
      {
        ...
        memo: "先以 Google Maps 搜尋「天ぷら たかお 熊本」確認當日營業時間與最近分店。高人氣優先點餐指引｜不限飲食：1. たかお天定食，原因是店名招牌方向，一次吃到綜合天婦羅；2. 蝦天定食，原因是天婦羅店最穩定的人氣品項；3. 魚介天婦羅定食，原因是口味比單吃蔬菜更有層次。無肉塊：野菜天婦羅加白飯；炸油與沾醬可接受和海鮮共用，若套餐附蝦魚天婦羅就分給同行者。",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        memo: "建議車子依舊安留 REF 免費停放。SWISS 高人氣優先點餐指引｜不限飲食：1. 鮮奶油草莓蛋糕，原因是洋菓子店經典人氣款，長輩小孩都容易接受；2. 季節水果蛋糕，原因是清爽、拍照與分食都合適；3. 巧克力蛋糕，原因是外帶較耐放，也是不敗熱門口味。無肉塊：布丁、泡芙或小份杯裝甜點；蛋奶與吉利丁可依個人接受度，重點避開明顯肉塊。",
