...
export const ITINERARY_DATA: ItineraryDay[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        memo: "停車：MERUKORO 店旁/店前專用停車場。高人氣優先點餐指引｜不限飲食：1. 可頌或奶油丹麥，原因是烘焙店最能看出酥皮與奶油香的熱門基本款；2. 鮮乳夾心包，原因是柔軟香甜，長輩小孩接受度高；3. 無花果核桃歐包，原因是歐包系常見人氣款，耐放也適合帶回別墅當早餐。方便素：原味、果乾、堅果或起司麵包，避開火腿、培根、明太子等鹹餡。",
      ...
      },
      {
        ...
        memo: "停車：住宿停車位，請依訂房指示停放。若改山麓キッチン燒肉外食，高人氣優先點餐指引｜不限飲食：1. 阿蘇赤牛燒肉拼盤，原因是最具在地代表性的招牌方向；2. 牛舌，原因是燒肉店常見高人氣品項，口感脆彈；3. 牛五花，原因是油脂香明顯，適合多人分食。方便素：白飯、沙拉與烤野菜，醬汁可能含肉或魚介萃取，介意者改鹽或原味。",
  ...
  },
  {
    ...
    note: "住：CAN LI ASSO。依 7/5 阿蘇日建議時程：上午草千里與火山口，中午 CAFE & SHOP GRASS LAND，下午大觀峰；保留黑川溫泉散策，但晚餐需在 17:00 前於阿蘇車站農產品店買好。",
    meals: {
    ...
    rainBackup: "阿蘇火山和中岳火山口極易受大雨或濃霧影響封鎖。若遭遇封鎖，火山口段改去阿蘇火山博物館；午餐仍保留 CAFE & SHOP GRASS LAND。下午若黑川散策遇雨，改為短停拍照或直接前往阿蘇車站農產品店採買晚餐，務必在 17:00 前買好再回 CAN LI ASSO。",
    ...
    items: [
      ...
      },
      {
        ...
        memo: "停車：草千里付費大停車場。高人氣優先點餐指引｜不限飲食：1. 阿蘇赤牛丼，原因是阿蘇代表食材優先，最符合到草千里用餐的在地感；2. 赤牛咖哩，原因是觀光餐廳常見熱門主餐，份量穩定；3. 阿蘇牛奶霜淇淋，原因是阿蘇乳製品系人氣甜點，餐後降溫也好分食。方便素：高菜飯、白飯、沙拉或麵包類，避開火腿、培根品項；咖哩醬可能含肉類高湯。",
      ...
      },
      {
        ...
        plan: "保留黑川溫泉散策，改成短停不泡湯：走一小段溫泉街、買甜點或茶飲、拍照後準時上車。若長輩或小孩累，就把黑川縮短為 30 分鐘，不取消後面的晚餐採買。",
        memo: "重點是 15:45 前離開黑川，才能在 17:00 前趕到阿蘇車站農產品店買好晚餐。高人氣優先點餐指引｜不限飲食：1. 溫泉布丁，原因是溫泉街常見人氣甜點，份量小也好入口；2. 泡芙或蛋糕，原因是甜點店熱門外帶品項，不影響後續移動；3. 咖啡或茶飲，原因是搭配甜點最穩，山路前也能休息醒腦。方便素：無肉甜點或無酒精飲品，多數甜點含蛋奶，介意吉利丁者現場確認。",
      ...
      },
      {
        ...
        move: "黑川溫泉街至阿蘇車站約 40-50 分鐘",
        plan: "在阿蘇車站旁農產品店把晚餐一次買齊，17:00 前完成採買上車。優先買阿蘇高菜飯糰、熟食便當、在地蔬果、ASO MILK 牛奶與布丁，回 CAN LI ASSO 直接分食，不再找晚餐餐廳。",
        memo: "若黑川停留超時，這站仍優先保留，因為晚餐要靠這裡補足。高人氣優先點餐指引｜不限飲食：1. 阿蘇赤牛便當，原因是在地代表性高、回別墅可直接吃；2. 阿蘇高菜飯糰，原因是阿蘇名物，適合長輩與小孩；3. ASO MILK 牛奶或布丁，原因是阿蘇乳製品人氣高。方便素：高菜飯糰、蔬果、麵包或甜點；熟食高湯與便當配菜可能含魚介或肉類。",
      ...
      },
      {
        ...
        move: "阿蘇車站至別墅約 35-45 分鐘",
        plan: "帶著阿蘇車站農產品店買好的晚餐回到南阿蘇舒適包棟別墅大客廳，全家圍坐分食熟食、飯糰、蔬果與甜點。",
        memo: "別墅住宿空間大。晚餐買回來後先把需冷藏的牛奶、布丁與水果放進冰箱。整理明天退房行李，確認只保留 3 個 29 寸大行李箱、1 個大型手提旅行包與嬰兒車。",
        mapUrl: "https://www.google.com/maps/search/?api=1&query=32.8234378,131.0261628",
        category: "hotel",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        memo: "若現場排隊太長，改外帶或附近簡餐，不影響 15:30 八千代座。高人氣優先點餐指引｜不限飲食：1. 阿蘇赤牛丼，原因是赤牛店最直覺、最熱門的招牌方向；2. 赤牛燒肉定食，原因是能吃到肉片香氣與口感，滿足度高；3. 赤牛牛排定食，原因是想認真吃阿蘇牛時最有代表性。方便素：高菜飯、漬物與白飯組合；味噌湯可能有魚介高湯，嚴格素不建議。",
      ...
      },
      {
        ...
        memo: "停車：飯店合作或自設大停車場。若晚餐在熊本新市街美食街自選，高人氣優先點餐指引｜不限飲食：1. 熊本拉麵，原因是黑蒜油豚骨最具熊本代表性；2. 壽司或海鮮丼，原因是商店街常見人氣選擇，食量彈性高；3. 居酒屋烤飯糰與炸物，原因是多人同行最容易補點分食。方便素：玉子、納豆、黃瓜卷、稻荷壽司、烤飯糰或冷豆腐；醬汁與高湯可能含魚介。",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        memo: "停車：AMU PLAZA 專用超大地下/立體停車場。黑亭高人氣優先點餐指引｜不限飲食：1. 玉子入りラーメン，原因是黑亭代表款方向，黑蒜油豚骨加蛋最完整；2. 黑亭拉麵基本款，原因是最能吃出焦蒜油與中粗麵特色；3. 煎餃或炒飯，原因是拉麵店常見人氣配餐，適合多人分食。方便素：黑亭本身不適合方便素，建議在 AMU PLAZA 改買飯糰、麵包或甜點；若仍同桌，可把叉燒分給其他人。",
      ...
      },
      {
        ...
        memo: "先以 Google Maps 搜尋「天ぷら たかお 熊本」確認當日營業時間與最近分店。高人氣優先點餐指引｜不限飲食：1. たかお天定食，原因是店名招牌方向，一次吃到綜合天婦羅；2. 蝦天定食，原因是天婦羅店最穩定的人氣品項；3. 魚介天婦羅定食，原因是口味比單吃蔬菜更有層次。方便素：野菜天婦羅加白飯；炸油與沾醬可能和海鮮共用，介意者改白飯與漬物。",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        memo: "停車：櫻之馬場 城彩苑 大專用停車場。高人氣優先點餐指引｜不限飲食：1. 海膽可樂餅，原因是城彩苑代表性人氣小吃，外酥內餡香濃；2. 熊本熊大判燒，原因是造型有記憶點，小孩接受度高；3. 阿蘇布丁或牛奶霜淇淋，原因是阿蘇乳製品系熱門甜點，7 月中午清涼好分食。方便素：紅豆或卡士達大判燒；多數甜點含蛋奶，不吃蛋奶者改茶飲或水果類商品。",
      ...
      },
      {
        ...
        memo: "建議車子依舊安留 REF 免費停放。SWISS 高人氣優先點餐指引｜不限飲食：1. 鮮奶油草莓蛋糕，原因是洋菓子店經典人氣款，長輩小孩都容易接受；2. 季節水果蛋糕，原因是清爽、拍照與分食都合適；3. 巧克力蛋糕，原因是外帶較耐放，也是不敗熱門口味。方便素：布丁、泡芙或小份杯裝甜點；多數含蛋奶，若介意吉利丁需現場確認。",
      ...
      },
      {
        ...
        memo: "建議車留飯店，直接步行前往。勝烈亭高人氣優先點餐指引｜不限飲食：1. 鹿兒島六白黑豚里脊豬排定食，原因是高階招牌方向，肉味濃、脂香明顯；2. 菲力豬排定食，原因是炸豬排店經典人氣部位，口感較嫩；3. 炸蝦或綜合炸物定食，原因是熱門替代選項，不想全吃豬排時可換口味。方便素：白飯、高麗菜、漬物與味噌湯；主菜肉類可分給其他人，味噌湯可能含魚介高湯。",
