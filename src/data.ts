  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        plan: "先在阿蘇車站旁農產品店把晚餐一次買齊，再往大觀峰。優先買阿蘇高菜飯糰、熟食便當、在地蔬果、ASO MILK 牛奶與布丁，回 CAN LI ASSO 直接分食，不再找晚餐餐廳。",
        memo: "採買移到大觀峰之前，避免黑川散策後趕 17:00。買到需冷藏的牛奶、布丁與水果，放保冷袋或車上陰涼處。高人氣優先點餐指引｜不限飲食：1. 阿蘇赤牛便當，原因是在地代表性高、回別墅可直接吃；2. 阿蘇高菜飯糰，原因是阿蘇名物，適合長輩與小孩；3. ASO MILK 牛奶或布丁，原因是阿蘇乳製品人氣高。方便素：高菜飯糰、蔬果、麵包或甜點；熟食高湯與便當配菜可能含魚介或肉類。",
      ...
      },
      {
        ...
        move: "阿蘇車站至大觀峰約 20-30 分鐘",
        plan: "晚餐買好後再上大觀峰。阿蘇外輪山最高展望點，環顧阿蘇五岳，其猶如靜躺的涅槃佛陀。晴朗首選、清風吹拂；霧氣若重，則保留 15 分鐘拍照後往黑川或回別墅。",
      ...
      },
      {
        ...
        memo: "16:10 前離開黑川，回別墅時間較穩。高人氣優先點餐指引｜不限飲食：1. 溫泉布丁，原因是溫泉街常見人氣甜點，份量小也好入口；2. 泡芙或蛋糕，原因是甜點店熱門外帶品項，不影響後續移動；3. 咖啡或茶飲，原因是搭配甜點最穩，山路前也能休息醒腦。方便素：無肉甜點或無酒精飲品，多數甜點含蛋奶，介意吉利丁者現場確認。",
