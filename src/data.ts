...
export const ITINERARY_DATA: ItineraryDay[] = [
  {
    ...
    date: "2026/07/04",
    weekday: "六",
    title: "抵達熊本、草千里午餐、南阿蘇補給、入住 CAN LI ASSO",
    subTitle: "草千里咖啡廳午餐、MERUKORO、高森補給，回別墅休息",
    ...
    mainTheme: "草千里午餐 ｜ 手作烘焙 ｜ 高森補給 ｜ 包棟自炊",
    note: "住：南阿蘇 CAN LI ASSO。第一天改為取車後上草千里咖啡廳吃中餐，再下山接 MERUKORO 與高森補給。抵達日不再硬排過多景點。",
    meals: {
      breakfast: "桃園機場簡單早餐或星宇航空機上早餐",
      lunch: "CAFE & SHOP GRASS LAND：草千里咖啡廳午餐，取車後直接上山吃飯與休息",
    ...
    rainBackup: "草千里若大雨或濃霧，午餐仍可在 CAFE & SHOP GRASS LAND 室內解決。若雨勢變大，縮短 MERUKORO，改以 Frein 超市與南阿蘇迷你超市補給為主，提早回 CAN LI ASSO 休息。",
    ...
    items: [
      ...
      },
      {
        ...
        move: "入境、免費接駁、拿車",
        plan: "領行李、取 TOYOTA Rent a Car W3 等級車、裝行李、確認幼童安全座椅、ETC 卡與導航設定及右駕防呆說明。取車後直接往草千里咖啡廳吃中餐。",
      ...
      },
      {
        time: "12:45 - 13:50",
        place: "熊本機場 → 草千里咖啡廳",
        move: "自駕約 60-70 分鐘，含上山路段",
        plan: "取車後直接往阿蘇山上方向，第一站改到草千里咖啡廳吃中餐。抵達日先找固定餐點與洗手間休息，不在機場簡餐草草解決。",
        memo: "第一天剛右駕上路，上山路段請放慢。若取車延誤超過 30 分鐘，仍可保留草千里午餐，但後面的 MERUKORO 需縮短。",
        category: "car",
      },
      {
        time: "13:50 - 14:35",
        place: "CAFE & SHOP GRASS LAND 草千里咖啡廳午餐",
        move: "草千里停車場旁用餐",
        plan: "第一天中餐改在草千里咖啡廳。用餐、上廁所、讓長輩與小孩下車放鬆，視天候簡短看草千里景色。",
      ...
      {
        time: "14:35 - 15:25",
        place: "草千里咖啡廳 → MERUKORO",
        move: "自駕約 40-50 分鐘，下山往南阿蘇方向",
        plan: "午餐後下山往南阿蘇生活圈，接 MERUKORO 補麵包與隔天早餐。",
        memo: "下山路段彎道多，避免午餐後太急。若草千里霧大或雨大，直接吃完離開，不安排戶外散步。",
        category: "car",
      },
      {
        time: "15:25 - 15:55",
