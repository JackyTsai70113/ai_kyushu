...
export const ITINERARY_DATA: ItineraryDay[] = [
  {
    ...
    restaurantTips: [
      {
        name: "MERUKORO 麵包店",
        timing: "第 1 天下午補給與車上點心",
        dishes: [
          {
            name: "可頌或奶油系丹麥麵包",
            reason: "剛出爐時奶油香與酥皮層次最明顯，適合當抵達後第一份補給。",
            vegetarianNote: "方便素可吃蛋奶素麵包；購買前避開火腿、培根、明太子等鹹餡。"
          },
          {
            name: "鮮乳夾心包或奶油麵包",
            reason: "甜度溫和、口感柔軟，小孩與長輩都容易入口。",
            vegetarianNote: "通常屬蛋奶素方向；若介意吉利丁或動物油，現場再確認原料。"
          },
          {
            name: "無花果、核桃或天然酵母歐包",
            reason: "耐放、比較不怕車上移動壓壞，適合帶回別墅當早餐。",
            vegetarianNote: "方便素優先選果乾、堅果、起司或原味麵包，避開肉類惣菜麵包。"
          }
        ]
      },
      {
        ...
        dishes: [
          {
            name: "阿蘇赤牛燒肉拼盤",
            reason: "最能吃到阿蘇牛肉香氣，適合多人分食，不用每人各點一份主餐。",
            vegetarianNote: "不適合方便素；可點白飯、沙拉、烤蔬菜，肉類交給其他人分食。"
          },
          {
            name: "牛舌或牛五花",
            reason: "油脂與口感差異明顯，可以和赤牛瘦肉拼盤互補。",
            vegetarianNote: "不適合方便素；若套餐附肉，直接把肉分給同行者。"
          },
          {
            name: "白飯、沙拉、烤野菜",
            reason: "燒肉店最穩定的配餐組合，也能平衡肉類油脂。",
            vegetarianNote: "方便素可點這組當主餐；醬汁可能含肉或魚介萃取，介意者改鹽或原味。"
          }
        ]
      }
    ],
  ...
  },
  {
    ...
    note: "住：CAN LI ASSO。依 7/5 阿蘇日建議時程：上午草千里與火山口，中午 CAFE & SHOP GRASS LAND，下午大觀峰；14:30 以後看體力決定鍋瀑布、黑川散策或直接回別墅休息。",
    meals: {
      breakfast: "於別墅享用：前一日在 MERUKORO、Frein 超市或高森周邊採購的麵包、牛奶、水果與簡單早餐",
      lunch: "CAFE & SHOP GRASS LAND：草千里旁午餐，避免下山找餐廳",
      dinner: "依 14:30 後體力決定：黑川溫泉街輕食，或直接回 CAN LI ASSO 別墅自炊／外帶"
    },
    weatherForecast: "阿蘇火山口與草千里屬中高海拔（標高約 1,140m），7 月山頂氣溫僅約 18°C~23°C，風勢甚猛、常現濃霧。紫外線偏高強，全體請備妥輕巧抗風防寒外套、太陽帽與遮陽傘。",
    rainBackup: "阿蘇火山和中岳火山口極易受大雨或濃霧影響封鎖。若遭遇封鎖，火山口段改去阿蘇火山博物館；午餐仍保留 CAFE & SHOP GRASS LAND。下午若鍋瀑布、菊池溪谷或黑川散策遇雨，直接縮短為大觀峰短停後回 CAN LI ASSO。",
    gasStationTip: "山區路段加油站較少。建議在中午山下至阿蘇市區用餐完，可在市區 【ENEOS】加油站加滿常規 Regular 油（Mantan），以策安全。",
    restaurantTips: [
      {
        name: "CAFE & SHOP GRASS LAND",
        timing: "第 2 天草千里午餐",
        dishes: [
          {
            name: "阿蘇赤牛丼或赤牛咖哩",
            reason: "在草千里不用下山就能吃到阿蘇代表食材，節省移動時間。",
            vegetarianNote: "不適合方便素；可點咖哩飯後把牛肉分給其他人，但醬汁可能仍含肉類高湯。"
          },
          {
            name: "高菜飯、飯糰或輕食套餐",
            reason: "比重口味主餐清爽，適合上午走完火山口後快速補充體力。",
            vegetarianNote: "方便素優先選高菜飯、白飯、沙拉或麵包類；仍需避開含火腿、培根的品項。"
          },
          {
            name: "阿蘇牛奶霜淇淋或乳製甜點",
            reason: "草千里休息站最適合用甜點作收尾，也方便小孩分食。",
            vegetarianNote: "蛋奶素可吃；若不吃蛋奶，就改買飲料或水果類伴手禮。"
          }
        ]
      },
      {
        name: "黑川溫泉街輕食、湯音、Patisserie Roku",
        timing: "第 2 天午後彈性備案",
        dishes: [
          {
            name: "溫泉街布丁或奶香甜點",
            reason: "份量小、停留時間短時也能快速補充熱量。",
            vegetarianNote: "蛋奶素可吃；若介意吉利丁，現場確認原料。"
          },
          {
            name: "泡芙、蛋糕或烘焙點心",
            reason: "適合外帶回車上或別墅，不影響後續行程。",
            vegetarianNote: "方便素可選不含肉的甜點；多數仍含蛋奶。"
          },
          {
            name: "咖啡、茶飲或冰品",
            reason: "下午山路前先休息醒腦，對駕駛比較實用。",
            vegetarianNote: "方便素可放心選無酒精飲品；加奶品項依個人蛋奶接受度決定。"
          }
        ]
      }
    ],
    items: [
      ...
      },
      {
        ...
        memo: "停車：草千里付費大停車場。若火山口管制或天候不佳，可直接提早進餐廳用餐與休息。",
      ...
      {
        time: "14:30 以後",
        place: "看體力決定：鍋瀑布 / 黑川散策 / 菊池溪谷 / 直接回別墅",
        move: "大觀峰後彈性選一條，不硬跑全部",
        plan: "依當天體力和天氣選：A. 鍋瀑布拍裏見瀑布；B. 黑川溫泉街散步，風の舎、湯音、Patisserie Roku；C. 菊池溪谷避暑；D. 直接回 CAN LI ASSO 休息。",
        memo: "這樣排的好處是上午不用折返、午餐穩定，下午保留彈性。鍋瀑布需線上預約；菊池溪谷距離較遠，若選它就不要再硬排黑川。",
  ...
  },
  {
    ...
    restaurantTips: [
      {
        ...
        dishes: [
          {
            name: "阿蘇赤牛丼",
            reason: "最直覺吃到赤牛肉香與白飯搭配，份量穩定，適合趕行程時快速用餐。",
            vegetarianNote: "不適合方便素；可點後把牛肉分給其他人，自己吃飯、蛋與配菜。"
          },
          {
            name: "赤牛燒肉或牛排定食",
            reason: "肉的厚度與口感比丼飯更明顯，適合想認真吃阿蘇牛的人。",
            vegetarianNote: "不適合方便素；可把主菜肉分出，保留白飯、味噌湯與漬物。"
          },
          {
            name: "高菜飯、漬物、味噌湯組合",
            reason: "清爽、好入口，也適合長輩不想吃太油時搭配。",
            vegetarianNote: "方便素優先選這類配菜與飯類；味噌湯可能有魚介高湯，嚴格素不建議。"
          }
        ]
      },
      {
        name: "熊本新市街美食街自選",
        timing: "第 3 天抵達熊本後晚餐備案",
        dishes: [
          {
            name: "熊本拉麵",
            reason: "晚到市區時上餐快，黑蒜油豚骨是熊本代表口味。",
            vegetarianNote: "不適合方便素；湯底多為豚骨，若點了可把叉燒分給其他人。"
          },
          {
            name: "壽司或海鮮丼",
            reason: "可按食量自由加減，長輩小孩也容易分食。",
            vegetarianNote: "方便素可選玉子、納豆、黃瓜卷、稻荷壽司；若店內沒有就改便利商店飯糰。"
          },
          {
            name: "居酒屋烤飯糰、玉子燒、炸物",
            reason: "多人同行最彈性，不餓的人也能只點小份。",
            vegetarianNote: "方便素可點烤飯糰、玉子燒、冷豆腐、薯條；醬汁與高湯可能含魚介。"
          }
        ]
      }
    ],
    items: [
      ...
      },
      {
        ...
        memo: "若現場排隊太長，改外帶或附近簡餐，不影響 15:30 八千代座。",
  ...
  },
  {
    ...
    meals: {
      ...
      dinner: "天ぷら たかお：現炸天婦羅定食，若排隊過長再改熊本市中心、下通商店街自選，步行可達，不累不折返"
    },
    ...
    restaurantTips: [
      {
        name: "熊本拉麵黑亭 熊本車站本店",
        timing: "第 4 天 AMU PLAZA 熊本午餐",
        dishes: [
          {
            name: "玉子入りラーメン",
            reason: "黑亭代表性的黑蒜油豚骨湯頭加上蛋，香氣、濃度與飽足感最完整。",
            vegetarianNote: "不適合方便素；湯底是豚骨，若仍想一起吃，可把叉燒分給其他人。"
          },
          {
            name: "黑亭拉麵基本款",
            reason: "最能確認熊本拉麵的焦蒜油與中粗麵特色，份量也比較好控制。",
            vegetarianNote: "不適合方便素；可請同行者接手叉燒，自己吃麵與蛋，但湯仍非素。"
          },
          {
            name: "煎餃或炒飯搭配分食",
            reason: "多人同行可加點分食，避免每個人都點大碗拉麵太撐。",
            vegetarianNote: "多半含肉；方便素若無合適品項，建議改在 AMU PLAZA 找飯糰、麵包或甜點補足。"
          }
        ]
      },
      {
        ...
        dishes: [
          {
            name: "たかお天定食或綜合天婦羅定食",
            reason: "一次吃到蝦、魚、蔬菜等招牌組合，最適合第一次到訪。",
            vegetarianNote: "不適合方便素完整食用；可把蝦與魚分給其他人，保留白飯、味噌湯與蔬菜天婦羅。"
          },
          {
            name: "野菜天婦羅加白飯",
            reason: "油炸蔬菜香甜，份量比肉魚主餐輕，適合晚上不想太撐。",
            vegetarianNote: "方便素首選；仍需注意炸油與沾醬可能和海鮮共用。"
          },
          {
            name: "明太子、淺漬小菜與白飯組合",
            reason: "天ぷら たかお常見亮點是配飯小菜，適合多人邊吃邊加點。",
            vegetarianNote: "明太子不是素；方便素可吃白飯與漬物，介意魚介高湯者避開味噌湯與沾醬。"
          }
        ]
      }
    ],
    items: [
      ...
      },
      {
        ...
        move: "完全步行，不累不折返",
        plan: "夜幕降臨，晚餐安排天ぷら たかお，吃現炸天婦羅定食，對長輩小孩也容易分食。若現場排隊過長，直接改回新市街、下通周邊的地產鄉土燒肉、定食或拉麵居酒屋。隨後即可安穩散回飯店泡舒適的大浴場，安睡。",
        memo: "先以 Google Maps 搜尋「天ぷら たかお 熊本」確認當日營業時間與最近分店。退房前夕，商店街旁有多家藥妝，伴手禮明信片均在此一網打盡。",
  ...
  },
  {
    ...
    meals: {
      ...
      dinner: "全日本炸豬排名店冠軍之首：勝烈亭新市街本店，招牌「鹿兒島六白里脊黑毛豬排大名套宴」；飯後外帶 SWISS 蛋糕回 REF 飯店當宵夜甜點"
    },
    ...
    restaurantTips: [
      {
        ...
        dishes: [
          {
            name: "海膽可樂餅",
            reason: "城彩苑代表性小吃，外酥內餡香濃，適合邊逛邊分食。",
            vegetarianNote: "不適合方便素；可改點甜點或布丁類，這份讓其他人吃。"
          },
          {
            name: "熊本熊大判燒或甜餡點心",
            reason: "造型有記憶點，小孩接受度高，也適合拍照。",
            vegetarianNote: "方便素可吃紅豆、卡士達等無肉口味；多數含蛋奶。"
          },
          {
            name: "阿蘇布丁或牛奶霜淇淋",
            reason: "清涼、好分食，適合 7 月中午降溫。",
            vegetarianNote: "蛋奶素可吃；若不吃蛋奶，就改買茶飲或水果類商品。"
          }
        ]
      },
      {
        ...
        dishes: [
          {
            name: "鮮奶油草莓蛋糕或季節水果蛋糕",
            reason: "經典、長輩小孩都容易接受，回飯店分切最方便。",
            vegetarianNote: "蛋奶素可吃；若介意吉利丁，購買時確認成分。"
          },
          {
            name: "巧克力蛋糕",
            reason: "比水果蛋糕耐放一點，外帶回飯店較不容易受擠壓影響。",
            vegetarianNote: "蛋奶素可吃；不吃蛋奶者不建議。"
          },
          {
            name: "布丁、泡芙或小份杯裝甜點",
            reason: "不用切蛋糕，適合每人各拿一份，打包行李時也比較好處理。",
            vegetarianNote: "蛋奶素可吃；若沒有純素品項，就選飲料或把甜點讓其他人吃。"
          }
        ]
      },
      {
        ...
        dishes: [
          {
            name: "鹿兒島六白黑豚里脊豬排定食",
            reason: "肉味濃、脂香明顯，是勝烈亭最值得吃的高階選項。",
            vegetarianNote: "不適合方便素；可把豬排分給其他人，自己吃白飯、高麗菜與小菜。"
          },
          {
            name: "菲力豬排定食",
            reason: "口感較嫩、油脂較低，適合長輩或不想吃太油的人。",
            vegetarianNote: "不適合方便素；處理方式同上，把主菜肉分給同行者。"
          },
          {
            name: "炸蝦或綜合炸物定食",
            reason: "不想全吃豬排時可換口味，多人同行也更好分食。",
            vegetarianNote: "不適合方便素；方便素可點白飯、高麗菜、漬物，必要時主菜交給其他人吃。"
          }
        ]
      }
    ],
    items: [
      ...
      {
        time: "14:20 - 17:30",
        place: "上通與下通商店街無障礙雙拱廊 ＆ SWISS 蛋糕外帶",
        move: "完全步行穿梭，悠然自得",
        plan: "兩旁皆為免稅大藥妝鋪，寬大不淋雨！逛街中途順手到熊本老字號洋菓子 SWISS 外帶蛋糕，晚上帶回 REF 飯店分食。喜歡購置的家人則在杉藥局、松本清、大國狂歡，各取所需互不耽誤。",
        memo: "建議車子依舊安留 REF 免費停放。SWISS 蛋糕先少量外帶，避免夏天長時間離開冷藏；若需要臨時開過來，使用下通周邊投幣付費格。",
      ...
      {
        time: "20:00 之後",
        place: "REF 飯店大廳打包行李 ＆ SWISS 蛋糕宵夜",
        move: "步行走回",
        plan: "在房間打包行囊，把彩妝與手信妥善折箱、封底膠。把外帶的 SWISS 蛋糕當最後一晚甜點分食，再去泡舒適大浴場。再次核查護照無缺，明天準時起飛！",
        memo: "確認每箱大型行裝不超限。蛋糕若吃不完先放房內冰箱；確認加油、Toyota 還車單、ETC文件已備齊放在手提袋內。",
        category: "rest",
      },
    ],
  },
