  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        memo: "這樣排的好處是上午不用折返、午餐穩定，下午保留彈性。若選黑川溫泉街輕食，高人氣優先點餐指引｜不限飲食：1. 溫泉布丁，原因是溫泉街常見人氣甜點，份量小也好入口；2. 泡芙或蛋糕，原因是甜點店熱門外帶品項，不影響後續移動；3. 咖啡或茶飲，原因是搭配甜點最穩，山路前也能休息醒腦。方便素：無肉甜點或無酒精飲品，多數甜點含蛋奶，介意吉利丁者現場確認。",
