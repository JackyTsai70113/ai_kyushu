...
export const ITINERARY_DATA: ItineraryDay[] = [
  {
    ...
    date: "2026/07/04",
    weekday: "六",
    title: "抵達熊本、MERUKORO、白川水源、16:45 道之驛阿蘇",
    subTitle: "先補給、再自然散步、16:45 準時至名站採買",
    hotel: "熊本阿蘇萬楓酒店 (Fairfield by Marriott Aso Resort)",
    ...
    items: [
      ...
      },
      {
        ...
        move: "入境、免費接駁、拿車",
        plan: "領行李、取 8 人座大型越野自駕、裝行李、確認幼童安全座椅、ETC卡與導航設定及右駕防呆說明。午餐以機場或車上簡餐處理。",
        memo: "停車/導航：Toyota 熊本機場店。六大一小不要壓線，注意行李堆疊空間。",
      ...
      },
      {
        ...
        memo: "山路會有一些，注意長輩與小孩在車上的狀況，朝 16:45 抵達阿蘇車站的硬限制前進。",
        category: "car",
      },
      {
        time: "13:40 - 14:10",
      ...
      },
      {
        time: "15:10 - 16:45",
        place: "白川水源 → 阿蘇車站周邊",
        move: "自駕約 70-90 分鐘 (包含上山路況及塞車緩衝)",
        plan: "不加入阿蘇神社／門前町，也不提早跑黑川溫泉。安全、專注駕駛，並預留阿蘇山路的通行時間偏好，直開至道之驛阿蘇。",
      ...
      },
      {
        ...
        move: "準時抵達特產站",
        plan: "最關鍵的硬性指標：準時 16:45 抵達，並大肆採買當晚豐盛晚餐、隔天早上所需的麵包早餐、優酪乳、水及零嘴。推薦品嚐阿蘇限定赤牛漢堡便當、手工布丁。",
        memo: "停車：道の駅 阿蘇 停車場。本店一般於 18:00 關店，故 16:45 抵達是非常完美的安排！",
      ...
      },
      {
        time: "17:30 - 17:40",
        place: "熊本阿蘇萬楓酒店 入住",
        move: "開車約 5-10 分鐘 (飯店與車站緊鄰)",
        plan: "辦理入住後，在寬敞精美的萬楓酒店交誼廳或客房内吃採購回來的晚餐。今天長度合適，大家早點入睡休息。",
        memo: "停車：飯店專用停車場。第一晚洗去一身塵埃不外出，萬楓設備先進、環境優質。",
        mapUrl: "https://www.google.com/maps/search/?api=1&query=32.936993,131.0792329",
        category: "hotel",
      },
    ],
  },
  {
    ...
    date: "2026/07/05",
    weekday: "日",
    title: "草千里、阿蘇火山口、大觀峰、黑川溫泉可選",
    subTitle: "壯麗火山景緻、外輪山極限界與高原溫泉假日",
    hotel: "瀨之本高原酒店 (Senomoto Kogen Hotel)",
    ...
    items: [
      {
        time: "08:30 - 09:10",
        place: "熊本阿蘇萬楓酒店 → 草千里",
        move: "自駕約 35-45 分鐘山路車程",
        plan: "享用朝食退房後，直接向阿蘇中岳山区出發，搶在上午天氣最為穩定、無濃霧干擾的黃金段參訪好景點。",
        memo: "山路向上需要集中注意力，長輩小孩在車上注意有無暈車、適時透清風半開窗戶。",
        category: "car",
      },
      {
        time: "09:10 - 10:40",
        place: "草千里 ＆ 草千里珈琲焙煎所",
        move: "停車後步道踏青拍照",
        plan: "火山遺跡巨大草原散步、與馬兒互動、拍照留念。走進新潮的焙煎咖啡所購買拉花拿鐵。若風大、冷霧，縮短草地漫遊，改在咖啡館內透過落地窗眺望大草原。",
      ...
      {
        time: "12:00 - 13:10",
        place: "あか牛丼専門店 ごとう屋阿蘇店",
        move: "山上至午餐約 20-30 分鐘",
        plan: "吃頂級名產『赤牛丼（Akaushi Dong）』。此店美味醇香，是家庭聚餐神鋪。地圖推薦餐廳必吃。Lion Curry 因停車場繁複及營業日不穩定，本版不排入備案。",
        memo: "停車：餐廳自設或周邊合作免費停車格，依現場指示停。人多時先抽整理券。",
      ...
      },
      {
        time: "15:20 - 16:00",
        place: "瀨之本高原酒店",
        move: "開往山上溫泉區約 35-45 分鐘",
        plan: "提早辦理入住、放下包袱，在大草原森林環繞的療癒溫泉飯店小憩，為隔天的高千穗精準峽谷划船蓄滿精神體力。",
        memo: "停車：酒店免費地上停車場。露天溫泉夜間星空是重頭戲，對長輩孩子都溫和怡人。",
        mapUrl: "https://www.google.com/maps/search/?api=1&query=33.0712093,131.1805005",
        category: "hotel",
      },
      {
        time: "16:20 - 17:30",
        place: "黑川溫泉可選散策 (風の舎、Patisserie Roku、湯音、いこい旅館)",
        move: "距飯店約 15-20 分鐘自駕",
        plan: "可選行程。在古樸懷舊的黑川溫泉街悠閒散步，吃 Patisserie Roku 的窯烤泡芙、湯音的特色牛奶冰淇淋、いこい旅館的日式溫泉蛋。若長輩疲累則果斷取消、多留在飯店享受高原微風與溫泉。",
        memo: "停車：風の舎 (黑川溫泉旅遊協同組合) 免費大停車場。階梯與陡坡較多，推車需慢走。",
        mapUrl: "https://www.google.com/maps/search/?api=1&query=33.0780191,131.1416136",
        category: "nature",
      },
    ],
  },
  {
    ...
    date: "2026/07/06",
    weekday: "一",
    title: "高千穗峽、小火車/神社取捨、熊本市區",
    subTitle: "船班優先焦點、神話深處散步與熊本REF大本營",
    ...
    items: [
      {
        time: "08:00 - 09:50",
        place: "瀨之本高原酒店出發 → 高千穗峽",
        move: "山路專注開車約 100-110 分鐘",
        plan: "早餐後直接辦退房出發，中途不繞路，僅做公路超商或洗手間短停，保持老小舒適。需提前抵達，絕對不可延誤划船班次報到。",
        memo: "山道曲折蜿蜒，易暈車的家人需提前服用防暈車藥、多閉目養神。",
        category: "car",
      },
      {
        time: "10:00 - 12:40",
        place: "高千穗峽 (預約划船) / 真名井瀑布",
        move: "停車至步道登山口慢行",
        plan: "全旅程黃金重頭戲：預約 7/6 峽谷划船、近看 17 米落下的真名井瀑布、彩虹水霧。划完船後慢步大石壁步道。午餐在『千穗之家 元祖流水麵』現場體驗流動竹管抓麵條，老少皆歡。",
        memo: "停車：高千穗峽專用付費大停車場，若停滿依引導前往臨時/第二停車場。大雨造成溪水猛漲划船會關閉，以此作安全雨備。",
      ...
      },
      {
        ...
        move: "車程僅 10 分鐘",
        plan: "彈性取捨點。體力充沛可前往坐卡丁露天小火車，在高達 105 米的全日本最高鐵路大橋頂眺望峽谷；若前段划船有所延遲或大家已顯疲累，果斷取消不坐直奔熊本市區。",
        memo: "停車：高千穂駅免費停車場。火車為預票或排隊，一切以高千穗划船為首要核心。",
...
export const TRAVEL_GUIDE_INFO = {
  ...
  driving: [
    ...
    {
      title: "加油步驟與油資結算指南",
      content: "租車合約規定『滿油還車』。在還車前 3 公里內找加油站。一般家庭車加『Regular (紅色油槍，日語：レギュラー)』。加滿油請向店員索取實體加油發票發票，Toyota 還車人員會現場仔細核對發票上的時間和地點以作查驗。"
    },
    {
  ...
  safety: [
    {
      ...
      content: "阿蘇火山是極其活耀的活火山，會排放大量具有毒性的二氧化硫與硫化氫氣體。管制分為【青(可上山)、黃(老人氣喘呼吸道敏感者停)、紅(全面封閉關閉)】。出發上車前，一定要打網頁『阿蘇火山火口規制情報』實時查看。若遇到大霧或高氣體濃度關閉，請果斷改去草千里，千萬不要強行上山。"
    },
    {
      title: "🚣 高千穗峽划船 ＆ 長輩兒童乘船防護",
      content: "高千穗峽谷划船一艘限乘 3 人。我們有六大一小，需分成 2-3 艘船。每個人都必須穿著救生衣。由於划船在窄長的陡壁水道，若遇到山區突然大雨造成水位激增、抑或峽谷落石，划船會當天停開，可在搭車前查看官網確認。划船時請注意長輩手腳不要伸出船體避免被其他船槳夾到。"
    },
    {
      title: "🎒 垃圾分類與車內整潔 (環保自學)",
      content: "日本公共場所、街道幾乎沒有一般的公共垃圾桶。一路上自駕產生的保特瓶、點心包裝紙、衛生紙，請在車內備好塑膠袋收納。在每天抵達便利商店、道の駅特產店或飯店退房時，在分類回收設施中將保特瓶、鐵罐、一般垃圾分類丟棄。愛護日本好山好水！"
    }
  ]
};
...
export const COMMON_PHRASES: Phrase[] = [
  ...
  { japanese: "免税（めんぜい）はできますか？", romaji: "Menzei wa dekimasu ka?", meaning: "請問這裡可以辦免税退稅嗎？", category: "shopping" },
...
export const INITIAL_CHECKLIST: ChecklistItem[] = [
  ...
  { id: "e2", text: "台灣駕照正本 ＋ 日文譯本 (兩張缺一不可！Toyota租車要查)", category: "essential", checked: false },
  ...
  { id: "c3", text: "替換乾衣物多件、雨傘/雨衣 (高千穗划船防瀑布飛濺/晴雨兩用)", category: "clothing", checked: false },
