...
export const ITINERARY_DATA: ItineraryDay[] = [
  {
    ...
    date: "2026/07/04",
    weekday: "六",
    title: "抵達熊本、MERUKORO 買麵包、いまきん食堂牛排丼、入住 CAN LI ASSO",
    subTitle: "熊本機場下飛機開始，先買 MERUKORO，再到 いまきん食堂吃阿蘇赤牛丼後回別墅（砂千里之濱 2026/7 封閉、不安排）",
    ...
    mainTheme: "熊本機場 ｜ 手作烘焙 ｜ いまきん食堂阿蘇赤牛丼 ｜ 包棟自炊",
    note: "住：南阿蘇 CAN LI ASSO。第一天從熊本機場下飛機開始，取車後先到 MERUKORO PAN-KOUBOU 買麵包，再到 いまきん食堂吃阿蘇赤牛丼，最後高森補給與入住。砂千里之濱因 2026/7 火山警戒與緊急工事封閉，本趟不安排（詳見當天底部備註）。大雨時不去白川水源，改走熊本機場 → 南阿蘇室內放電 → 阿蘇補給 → 入住。草帽雕像可選短停：娜美像（俵山交流館 萌の里），雨小且取車順利才拍。",
    advisory: "🌋 火山：2026/06/21 阿蘇噴火警戒升至 Lv.2（火口周辺規制）。砂千里ヶ浜因緊急工事 2026/06/15–07/31 立入禁止，本趟（7/4）無法進入，已從行程移除。Day 1 主午餐改為 いまきん食堂；草千里不作本日主行程。\n🌧️ 天候：7 月為梅雨末期、雨量大、山區易起霧；若山區濃霧或大雨，第一天以室內放電、牛奶甜點、道之驛補給與提早入住為主。出發當天請再查 aso-volcano.jp（火山即時）與 tenki.jp／weathernews（兩週天氣）。",
    meals: {
      breakfast: "桃園機場簡單早餐或星宇航空機上早餐",
      lunch: "いまきん食堂：阿蘇內牧名物赤牛丼 / 牛排丼；買完 MERUKORO PAN-KOUBOU 麵包後前往，用餐與休息",
      dinner: "高森／南阿蘇採買：Frein 超市、丸福蔬果攤、南阿蘇迷你超市，或山麓キッチン燒肉外食後回 CAN LI ASSO"
    },
    weatherForecast: "熊本平地高溫約 28°C~31°C 稍感悶熱；往阿蘇山區前行後，氣溫會平緩降至舒服的 21°C~25°C。午後多雲偶晴，山區仍有短暫偶雨機率，建議帶防曬帽與防風薄外衣。【景觀提醒】7 月為九州梅雨末期、月雨量約 400mm、阿蘇山區易起霧；Day 1 已改以 いまきん食堂午餐與室內/補給點為主，不硬排草千里展望。",
    rainBackup: "Day 1 大雨雨備核心：第一天不要去白川水源。大雨時白川水源對長輩、小孩、嬰兒車都麻煩，鞋子濕掉後整天會不舒服，改成室內放電、牛奶甜點與道之驛補給。建議動線：10:45-13:00 抵達熊本機場、入境、領車、機場簡單午餐；13:00-13:45 熊本機場往南阿蘇；13:45-16:10 阿蘇ファームランド / 阿蘇元気の森，作為大雨主力，日歸可用室內體驗、餐飲、伴手禮與溫泉等設施，部分項目按設施付費；若時間縮短，插入 ASO MILK FACTORY 買牛奶、優格、甜點、起司、咖啡。16:10-16:45 移動到道の駅 阿蘇；16:45-17:25 採買晚餐與隔天早餐，盡量不要晚於 17:30 才到；17:25-18:00 回 CAN LI ASSO 入住，熱飯、洗澡、烘乾鞋襪，第一天不再外出。阿蘇猿まわし劇場只在出發當天確認官網公演表或電話確認有公演時插入，否則不列主備案。草千里、娜美像、砂千里都不作大雨硬排；砂千里之濱本趟封閉、已不安排。",
    gasStationTip: "熊本機場取車時 Toyota 租車已提供滿油狀態；第一天改走 いまきん食堂與阿蘇內牧方向，總車程變長但仍通常不需加油。若遇緊急狀況，阿蘇地區周邊即有【ENEOS 南阿蘇店】加油站。",
    items: [
      {
        time: "07:30 - 10:45",
      ...
      },
      {
        ...
        move: "入境、免費接駁、拿車",
        plan: "領行李、取 TOYOTA Rent a Car W3 等級車、裝行李、確認幼童安全座椅、ETC 卡與導航設定及右駕防呆說明。取車後先往 MERUKORO PAN-KOUBOU 買麵包，再去 いまきん食堂吃阿蘇赤牛丼。",
      ...
      },
      {
        ...
        memo: "第一天剛右駕上路，先走相對好掌握的南阿蘇生活圈。若取車延誤超過 30 分鐘，MERUKORO 只買重點品項，避免 いまきん食堂午餐太晚。",
        category: "car",
      },
      {
        time: "13:00 - 13:15 可選",
      ...
      },
      {
        ...
        move: "車停店前、進店採買",
        plan: "採買現烘麵包、熱美式、車上點心與隔天早餐。這站先買，後面就直接往 いまきん食堂午餐，不再上草千里。",
      ...
      {
        time: "14:00 - 14:55",
        place: "MERUKORO PAN-KOUBOU → いまきん食堂",
        move: "自駕約 35-50 分鐘，往阿蘇內牧方向",
        plan: "買完麵包後前往阿蘇內牧的 いまきん食堂。這段不再上草千里，減少山上濃霧與火山管制不確定性。",
        memo: "いまきん食堂人氣高，抵達後以現場排隊與當日營業為準；若已售完或等候過久，改 ASO MILK FACTORY 或道の駅 阿蘇補餐。",
        category: "car",
      },
      {
        time: "14:55 - 15:45",
        place: "いまきん食堂 / IMAKIN 食堂 牛排丼",
        move: "阿蘇內牧用餐與休息",
        plan: "第一天中餐改為 いまきん食堂，主攻阿蘇名物赤牛丼 / 牛排丼。用餐、上廁所，讓長輩與小孩下車放鬆；若排隊過久就改道の駅 阿蘇或 ASO MILK FACTORY。",
        memo: "停車與營業以當日 Google Maps / 官方公告為準。高人氣優先點餐指引｜不限飲食：1. あか牛丼 / 赤牛丼，原因是店家代表名物；2. 赤牛定食或牛排類，原因是多人分食彈性高；3. 小菜、白飯或湯品，原因是長輩小孩可補份量。無肉塊：白飯、漬物、湯品與同行分食；若不能吃牛肉，這站不適合作為主餐。",
        mapUrl: "https://www.google.com/maps/search/?api=1&query=%E3%81%84%E3%81%BE%E3%81%8D%E3%82%93%E9%A3%9F%E5%A0%82%20%E9%98%BF%E8%98%87%20%E8%B5%A4%E7%89%9B%E4%B8%BC",
        category: "food",
      },
      {
        time: "16:45 - 17:20",
        ...
        move: "いまきん食堂後往高森周邊採買",
        plan: "用餐後改在住宿順路的高森與南阿蘇生活圈採買晚餐、隔天早餐、水、牛奶、水果與零食。Frein 超市營業至 22:00，南阿蘇迷你超市至 20:00，可作為備援。",
  ...
  },
  {
    ...
    rainBackup: "Day 2 大雨雨備核心：火山口封閉已是預設，濃霧大雨時不要硬上展望點，也不要去濕滑瀑布步道。主軸改為 ASO MILK FACTORY 深度停留、道の駅 阿蘇補給、阿蘇駅前烏索普像小雨短拍與室內休息。建議動線：早餐後先確認 aso-volcano.jp；若山上封閉或霧雨明顯，直接去 ASO MILK FACTORY，午餐、牛奶、優格、布丁、起司、霜淇淋、咖啡與商店一次處理。午餐後可到道の駅 阿蘇買晚餐熟食、蔬果與伴手禮，順路在阿蘇駅前短拍烏索普像；雨大就只在車上看或跳過。大觀峰濃霧時取消或只停 10 分鐘；瀬の本レストハウス保留為室內廁所與伴手禮休息站；黑川雨大只短停風の舎或甜點外帶，體力差直接回 CAN LI ASSO。阿蘇火山博物館只在草千里道路安全、大家想補火山知識時加入。鍋ヶ滝只在已預約且雨勢小時去，大雨濕滑取消。",
...
export const TRAVEL_GUIDE_INFO = {
  ...
  safety: [
    ...
    },
    {
      ...
      content: "【2026/7 更新】砂千里ヶ浜因緊急工事 6/15–7/31 立入禁止，本趟已從 Day 1 移除；Day 1 午餐主點改為 いまきん食堂阿蘇赤牛丼 / 牛排丼，不再把草千里 Green Park 當午餐主行程。Day 2 阿蘇中岳火山口因 Lv.2 管制與道路封閉無法上去，直接以 ASO MILK FACTORY 為午餐與主活動，再接大觀峰、瀬の本、黑川。若時間、體力、天氣與預約條件都符合，午後可加選鍋ヶ滝；大雨或濃霧則提早到黑川溫泉街或直接回 CAN LI ASSO。"
    },
    {
      title: "高千穗峽步道與長輩兒童防護",
...
export const INITIAL_CHECKLIST: ChecklistItem[] = [
  ...
  { id: "c2", text: "好走不易滑的運動鞋 (大觀峰、白川水源、高千穗峽步道與雨天停車場路面可能濕滑)", category: "clothing", checked: false },
